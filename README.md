...
- **Workspace Session Manager (多命名工作区管理)** — Save currently open tabs as separate named workspaces (e.g. "AI Coding", "Travel Planning"). Swap or restore them easily from the Saved Workspaces sidebar pane, fully equipped with individual delete controls and tactile slide-in transitions.
